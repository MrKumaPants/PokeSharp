...
public class ConsoleServices
{
        ...
        WatchPresetManager watchPresetManager)
    {
        ...
        ScriptEvaluator = scriptEvaluator ?? throw new ArgumentNullException(nameof(scriptEvaluator));
...
public class ConsoleLoggingCallbacks
{
    ...
    /// </summary>
    public Func<Microsoft.Extensions.Logging.LogLevel> GetLogLevel { get; }

    /// <summary>
    /// Sets the minimum log level.
    /// </summary>
    public Action<Microsoft.Extensions.Logging.LogLevel> SetLogLevel { get; }

    public ConsoleLoggingCallbacks(
        Func<bool> isLoggingEnabled,
        Action<bool> setLoggingEnabled,
        Func<Microsoft.Extensions.Logging.LogLevel> getLogLevel,
        Action<Microsoft.Extensions.Logging.LogLevel> setLogLevel)
    {
        IsLoggingEnabled = isLoggingEnabled ?? throw new ArgumentNullException(nameof(isLoggingEnabled));
        SetLoggingEnabled = setLoggingEnabled ?? throw new ArgumentNullException(nameof(setLoggingEnabled));
