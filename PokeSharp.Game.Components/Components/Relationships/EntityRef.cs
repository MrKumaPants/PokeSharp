...
public struct EntityRef
{
    ...
    {
        _entity = entity;
        _generation = entity.Id; // Simplified generation tracking
    }
    ...
    /// </remarks>
    public readonly Entity Value => _entity;

    /// <summary>
    /// Gets the generation captured when this reference was created.
    /// </summary>
    public readonly int Generation => _generation;
    ...
    /// </summary>
    public static EntityRef Null => new() { _entity = Entity.Null, _generation = -1 };

    /// <summary>
    /// Checks if this is a null reference.
    /// </summary>
    public readonly bool IsNull => _entity == Entity.Null;
}
