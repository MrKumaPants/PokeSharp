...
public class UITheme
{
    ...
    public static UITheme OneDark { get; } = new UITheme
    {
        // ═══════════════════════════════════════════════════════════════
    ...
    public static UITheme Monokai { get; } = new UITheme
    {
        ...
        PaddingTiny = 2, PaddingSmall = 4, PaddingMedium = 8, PaddingLarge = 12, PaddingXLarge = 20,
        MarginTiny = 2, MarginSmall = 4, MarginMedium = 8, MarginLarge = 12, MarginXLarge = 20,
        FontSize = 16, LineHeight = 20, ScrollbarWidth = 10, ScrollbarPadding = 4, BorderWidth = 1,
        ButtonHeight = 30, InputHeight = 30, DropdownItemHeight = 25, PanelRowHeight = 25,
        AnimationSpeed = 1200f, FadeSpeed = 4f, CursorBlinkRate = 0.5f,
        ...
        MinInputHeight = 35f, MaxSuggestionsHeight = 300f,
        TooltipGap = 5f, ComponentGap = 10f, PanelEdgeGap = 20f, SuggestionPadding = 20f,
        DragThreshold = 5f, DoubleClickMaxDistance = 5f, DoubleClickThreshold = 0.5f,
    ...
    public static UITheme Dracula { get; } = new UITheme
    {
    ...
    public static UITheme GruvboxDark { get; } = new UITheme
    {
    ...
    public static UITheme Nord { get; } = new UITheme
    {
    ...
    public static UITheme SolarizedDark { get; } = new UITheme
    {
    ...
    public static UITheme Pokeball { get; } = new UITheme
    {
        // ═══════════════════════════════════════════════════════════════
    ...
    public static UITheme SolarizedLight { get; } = new UITheme
    {
        // ═══════════════════════════════════════════════════════════════
