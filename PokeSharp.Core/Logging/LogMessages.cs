...
public static partial class LogMessages
{
    ...
    public static partial void LogMovementBlocked(
        this ILogger logger, int x, int y, int mapId);

    [LoggerMessage(
        EventId = 1001,
        Level = LogLevel.Debug,
        Message = "Ledge jump blocked: landing out of bounds ({X}, {Y})")]
    public static partial void LogLedgeJumpBlocked(
        this ILogger logger, int x, int y);

    [LoggerMessage(
        EventId = 1002,
        Level = LogLevel.Debug,
        Message = "Ledge jump blocked: landing position blocked ({X}, {Y})")]
    public static partial void LogLedgeLandingBlocked(
        this ILogger logger, int x, int y);
    ...
    public static partial void LogLedgeJump(
        this ILogger logger, int startX, int startY, int endX, int endY, string direction);
    ...
    public static partial void LogCollisionBlocked(
        this ILogger logger, int x, int y, string direction);
    ...
    public static partial void LogEntityProcessing(
        this ILogger logger, int entityCount, string systemName);

    [LoggerMessage(
        EventId = 2001,
        Level = LogLevel.Information,
        Message = "Indexed {Count} static tiles into spatial hash")]
    public static partial void LogSpatialHashIndexed(
    ...
    public static partial void LogAnimatedTilesProcessed(
        this ILogger logger, int count);
    ...
    public static partial void LogSlowFrame(
        this ILogger logger, float frameTimeMs, float targetMs);
    ...
    public static partial void LogFrameTimeStats(
        this ILogger logger, float avgMs, float fps, float minMs, float maxMs);
    ...
    public static partial void LogSystemStats(
        this ILogger logger, string systemName, double avgMs, double maxMs, long updateCount);
    ...
    public static partial void LogTextureLoaded(
        this ILogger logger, string textureId, double timeMs, int width, int height);
    ...
    public static partial void LogSlowTextureLoad(
        this ILogger logger, string textureId, double timeMs);
    ...
    public static partial void LogMemoryWithGc(
        this ILogger logger, double memoryMb, int gen0, int gen1, int gen2);
    ...
    public static partial void LogHighMemoryUsage(
        this ILogger logger, double memoryMb, double thresholdMb);
    ...
    public static partial void LogSystemsInitializing(
        this ILogger logger, int count);
    ...
    public static partial void LogSystemInitializing(
        this ILogger logger, string systemName);

    [LoggerMessage(
        EventId = 5002,
        Level = LogLevel.Information,
        Message = "All systems initialized successfully")]
    public static partial void LogSystemsInitialized(
        this ILogger logger);
    ...
    public static partial void LogSystemRegistered(
        this ILogger logger, string systemName, int priority);
}
